...
function displayPics(){
  ...
  // Because the variable (rando) when declared with (let) inside a while statement has a block scope only which is inside the while statement only and not for the whole function.
  console.log(viewed);
