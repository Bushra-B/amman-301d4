...
// (this) refers to the (window) when the arrow function is used.
// 3. Explain why "this" is different when an arrow function is used.
// Because the arrow function affects function-scopes and doesn't bind (this), so (this) refers to the whole window instead of refering to the block-scope.
